...
mds <- cmdscale(as.dist(D), k = nrow(D) - 1, eig = TRUE)

# os dois primeiros autovalores são consideravelmente maiores do que os demais
mds$eig %>% 
  round(4)
...
# TAREFA: varie o numero de grupos (k) e a função de ligação
